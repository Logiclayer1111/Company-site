...
const botResponses: Record<string, string> = {
  default: "I'm Draxilon's AI assistant. I can help you explore our services, discuss your project, or connect you with our team. What are you looking to build?",
  ...
  contact: "You can reach us at hello@Draxilon.io or call +1 (212) 555-0100. Or fill out our contact form and we'll respond within 24 hours.",
        ...
        {open && (
          ...
          >
            ...
            <div className="bg-gradient-to-r from-blue-600 to-violet-600 px-4 py-3 flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-white">Draxilon AI</p>
